...
class AppStartupReadyView extends StatelessWidget {
  const AppStartupReadyView(this.destination, {super.key});
...
class AppStartupFailureView extends StatelessWidget {
  const AppStartupFailureView({required this.onRetry, super.key});
